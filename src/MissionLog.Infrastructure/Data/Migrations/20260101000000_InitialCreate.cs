...
namespace MissionLog.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalActions_WorkOrders_WorkOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_WorkOrderId",
            ...
            // Demo users are seeded at runtime via DatabaseSeeder (BCrypt requires runtime hashing)
        }
